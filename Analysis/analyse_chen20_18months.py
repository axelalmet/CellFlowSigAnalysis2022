...
adata_chen = sc.read(data_directory + 'chen20_18months.h5ad')

# Import the cellchat dataframes
cellchat_chen_wt = pd.read_csv(cellchat_directory + 'chen20_communications_WT_18.csv')
cellchat_chen_ad = pd.read_csv(cellchat_directory + 'chen20_communications_AD_18.csv')
...
cellchat_output_chen = {'WT_18':cellchat_chen_wt, 'AD_18':cellchat_chen_ad}
...
cellproximities_chen_ctrl = pd.read_csv(giotto_directory + 'chen20_cellproximities_coords_WT_18.csv')
cellproximities_chen_stim = pd.read_csv(giotto_directory + 'chen20_cellproximities_coords_AD_18.csv')
...
cfs.pp.construct_celltype_ligand_expressions(adata_chen,
                                            celltype_label='AT',
                                            node_sep='_',
