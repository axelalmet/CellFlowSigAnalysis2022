...
# my_instructions = createGiottoInstructions(python_path = '/Users/axelalmet/Library/r-miniconda/envs/r-reticulate/bin/python')
...
# Save the files
write.csv(wt_cell_proximities$enrichm_res, paste(chen_data_directory, "chen20_cellproximities_WT_03.csv", sep=""))
write.csv(ad_cell_proximities$enrichm_res, paste(chen_data_directory, "chen20_cellproximities_AD_03.csv", sep=""))
